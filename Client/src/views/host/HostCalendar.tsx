...
const HostCalendar: React.FC = () => {
   ...
   // Month view: continuous vertical scroll across 12 months from the selected one
   ...
   /** Month-view day cell — out-of-month days render empty so dates never repeat */
