...
/** Trang chao mung lan dau chuyen sang che do host */
const HostWelcome: React.FC = () => {
   const navigate = useNavigate();
   const { user } = useAuth();
   const queryClient = useQueryClient();

   // Danh dau da xem tren SERVER (theo tai khoan, doi may van dung)
   useEffect(() => {
      apiMarkHostWelcomeSeen()
         ...
         .catch(() => {
            // mang loi: lan sau se hien lai welcome — chap nhan duoc
         });
